	...
	*/
	...
	public static function load_admin_resources() {
		...
		if ( UIFORM_DEV === 1 ) {
			...
			wp_enqueue_script( 'rockefform-dev-6', UIFORM_FORMS_URL . '/assets/backend/js/zgfm-back-calc.js', array(), date( 'YmdHis' ), true );
			...
			wp_enqueue_script( 'rockefform-dev-42', UIFORM_FORMS_URL . '/assets/common/js/uiform-sticky.js', array(), date( 'YmdHis' ), true );
			...
			wp_register_script(
				self::PREFIX . 'admin',
				UIFORM_FORMS_URL . '/assets/backend/js/blank.js',
				array(),
				date( 'YmdHis' ),
				true
			);
