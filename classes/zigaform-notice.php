...
class Zigaform_c_notice
{
    ...
    public function notice_rated()
    {
        ...
        $data              = get_option('zigaform_c_notice_1', array());
        $data['time']      = time();
        $data['dismissed'] = true;
        $data['rated']     = true;

        update_option('zigaform_c_notice_1', $data);
        die();
    }
    ...
    public function notice_add()
    {
        ...
        $data = get_option('zigaform_c_notice_1');
        $time = time();
        $load = false;
        ...
        <div class="notice zgfm-ext-notice" style="display: none;">
            ...
            <div class="zgfm-ext-notice-message">
            ...
            <div class="zgfm-ext-notice-cta">
                ...
                <button class="zgfm-ext-notice2-act2 button" data-msg="<?php esc_html_e('Saving', 'FRocket_admin'); ?>">
                    <?php echo $button_content2; ?>
                </button>
                <button class="zgfm-ext-notice-dismiss zgfm-dismiss-rated" data-msg="<?php esc_html_e('Saving', 'FRocket_admin'); ?>">
