...
// forms
        $sql = "CREATE  TABLE IF NOT EXISTS $this->form (
            ...
            `fmb_default` TINYINT NULL DEFAULT 0 ,
            `fmb_skin_status` TINYINT NULL DEFAULT 0 ,
            `fmb_skin_data` longtext NULL ,
            `fmb_skin_type` SMALLINT NULL DEFAULT 1 ,
...
if ( isset($uifm_check_total['total']) && intval($uifm_check_total['total']) === 0) {
    $sql = "INSERT INTO $this->settings VALUES ('7.1.9', null, null, null, null, null, null, '', '1');";
    $wpdb->query($sql);
}
