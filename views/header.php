...
<div class="sfdc-navbar-header">
          ...
          <a href="javascript:location.reload();" class="navbar-brand"><img title="Rocket Form" src="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/image/rockfm-logo-header.png"></a>
        </div>
