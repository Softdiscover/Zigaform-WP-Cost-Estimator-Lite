      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform';?>"><?php echo __('New','FRocket_admin'); ?></a></li>
            ...
            <?php } ?>
            <li class="divider"></li>
            <li><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=list_uiforms';?>"><?php echo __('List forms','FRocket_admin'); ?></a></li>
          </ul>
        </li>
        <?php if(isset($_GET['action']) && Uiform_Form_Helper::sanitizeInput($_GET['action'])==='create_uiform'){?>
        <li class="divider-menu"></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=records&action=list_records';?>">
           ...
           <?php }else{ ?>
                <li><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=records&action=info_records_byforms';?>">
           ...
           <?php } ?>
            ...
            <?php }else{ ?>
                ...
                <li><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=records&action=custom_report';?>">
        ...
        <li class="divider-menu"></li>
         ...
         <?php if(ZIGAFORM_C_LITE == 1){ ?>
           ...
           <?php }else{ ?>
                 <li ><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=gateways&controller=records&action=list_records';?>">
        ...
        <?php }else{ ?>
             <li >
            <a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform&opt=import';?>">
        ...
        <?php }else{ ?>
            <li>
                <a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=export_form';?>">
        ...
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=records&action=view_charts';?>">
            <span class="fa fa-area-chart"></span> <?php echo __('Charts','FRocket_admin'); ?> 
            </a>
        </li>
        <li class="divider-menu"></li> 
        <li ><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=settings&action=view_settings';?>">
            <i class="fa fa-cog"></i> <?php echo __('Settings','FRocket_admin'); ?>
            </a>
        </li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=settings&action=backup_settings';?>">
            <i class="fa fa-cloud-download"></i> <?php echo __('Backup','FRocket_admin'); ?>
            </a>
        </li>
        <li class="divider-menu"></li>
        <li ><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=gateways&controller=settings&action=view_settings';?>">
        ...
        <li class="divider-menu"></li> 
        <li ><a href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=settings&action=system_check';?>">
