                            ...
                            <form role="form">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                            <a href="https://wordpress.org/support/plugin/zigaform-calculator-cost-estimation-form-builder-lite/reviews/?filter=5#new-post"
                                               target="_blank">
                            ...
                            <form role="form">
                                <fieldset>
                                    <div class="form-group">
                                            ...
                                            $share_this_data = "st_url='https://softdiscover.com/zigaform/wordpress-cost-estimator/' st_title='{$title}' st_summary='{$summary}'";
                                            ?>
