...
<div class="zgfm-page-pro-box sfdc-wrap">
  <img src="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/image/express/logo-to-pro.png" alt="Upgrade Logo">
  <h2>
    <div>
      ...
      <table class="table table-condensed table-hover zgfm-table-striped">
        ...
        <tbody>
          ...
          $features = [
            ...
            ['Backup', true, true],
            ['Math Calculation', true, true],
            ['Paypal payment', false, true],
            ['Invoice feature', false, true],
            ...
            ['Export Form records', false, true],
