...
if (class_exists('zgfm_clientSniffer') ) {
    return;
}
class zgfm_clientSniffer {
...
zgfm_clientSniffer::systems(array(
...
zgfm_clientSniffer::browsers(array(
	"Links"				=> NULL,
	"Midori"			=> NULL,
...
zgfm_clientSniffer::engines(array(
	"WebKit"			=> NULL,
	"KHTML"				=> NULL,
