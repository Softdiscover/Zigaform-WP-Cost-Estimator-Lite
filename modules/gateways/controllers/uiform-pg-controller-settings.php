 ...
 * @link      https://wordpress-cost-estimator.zigaform.com
 */
class Uiform_Pg_Controller_Settings extends Uiform_Base_Module
{
    ...
    public function ajax_save_options()
    {
        ...
        $result                 = $this->wpdb->update($this->model_gateways->table, $data, $where);
        $json2                  = array();
        if ( $result > 0) {
            $json2['success'] = 1;
        } else {
    ...
    public function view_settings()
    {
        ...
        echo self::loadPartial('layout.php', 'gateways/views/settings/view_settings.php', $data);
    }
        ...
        switch ( intval($id)) {
            case 1:
                ...
                $other_options = json_decode($rdata->pg_data, true);
                    ...
                    echo self::loadPartial('layout.php', 'gateways/views/settings/editoffline.php', $data);
                break;
            case 2:
                /*paypal*/
                    $other_options = json_decode($rdata->pg_data, true);
                ...
                foreach ( $currencies as $key => $value) {
                    ...
                    echo self::loadPartial('layout.php', 'gateways/views/settings/editpaypal.php', $data);
                break;
            default:
                    $data['query'] = $this->model_gateways->getListGateways();
                    echo self::loadPartial('layout.php', 'gateways/views/settings/view_settings.php', $data);
