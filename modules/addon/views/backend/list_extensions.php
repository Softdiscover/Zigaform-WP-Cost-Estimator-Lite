                                    ...
                                    <div class="row">
                                        ...
                                        <div class="zgfm-ext-buttons">
                                                        ...
                                                        if (ZIGAFORM_F_LITE === 0 || strval($value->add_name) === 'woocommerce' || strval($value->add_name) === 'mgtranslate') {
                                                            ?>
                                                            <?php if (!isset($value->required_wp) ||
                                                            version_compare($wp_version, $value->required_wp, '>=') && version_compare(PHP_VERSION, $value->required_php, '>=')) { ?>
                                        ...
                                        <div class="col-md-6 list-options">
                                            ...
                                            <ul>
                                                ...
                                                <?php
                                                if (version_compare($wp_version, $value->required_wp, '>=')) {
                                                    ?>
