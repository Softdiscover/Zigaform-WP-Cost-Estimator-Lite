                            ...
                            <li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="zgfm-ext-buttons">
                                                        ...
                                                        <?php
                                                        if (ZIGAFORM_F_LITE === 0 || strval($value->add_name) === 'woocommerce') {
                                                            ?>
                                                            <?php if (version_compare($wp_version, $value->required_wp, '>=') && version_compare(PHP_VERSION, $value->required_php, '>=')) {?>
                                        ...
                                        <div class="col-md-6 list-options">
                                            ...
                                            <ul>
                                                ...
                                                <li><b><?php echo __('WP', 'FRocket_admin'); ?></b> : 5.5+ 
                                                <?php if (version_compare($wp_version, $value->required_wp, '>=')) {
