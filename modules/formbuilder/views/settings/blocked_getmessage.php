...
<div class="zgfm-blocked-message-box">
    ...
    <div class="zgfm-blocked-message-box-msg">
        <?php echo sprintf(__( 'We\'re sorry, %s is not available on free version.<br><br>Please upgrade to Pro version to unlocks all these features, and puts you on the upgrade path for additional features that we’re excited to share in the near future.', 'FRocket_admin' ),$message);?>
    </div>
