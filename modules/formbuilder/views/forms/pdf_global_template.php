                    ...
                    case 3:
                        ...
                        ?>
                           @font-face {
                            ...
                            font-style: normal;
                            font-weight: 400;
                            src: url("<?php echo UIFORM_FORMS_URL; ?>/helpers/dompdf/lib/fonts/BMYEONSUNG_ttf.ttf") format('truetype');
                          }
                          * {
                    ...
                    case 4:
                        ...
                        ?>
                           @font-face {
                            ...
                            font-style: normal;
                            font-weight: 400;
                            src: url("<?php echo UIFORM_FORMS_URL; ?>/helpers/dompdf/lib/fonts/mushin.otf") format('truetype');
                          }
                          * {
                    ...
                    case 5:
                        ...
                        ?>
                           @font-face {
                            ...
                            font-style: normal;
                            font-weight: 400;
                            src: url("<?php echo UIFORM_FORMS_URL; ?>/helpers/dompdf/lib/fonts/chinesefont.ttf") format('truetype');
                          }
                          * {
