  ...
  <div class="zgfm_container">
    <div class="option-cards">
      <div class="option-card" data-template="single">
        <img src="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/image/single-form.svg" alt="<?php echo __('Single Form', 'FRocket_admin'); ?>" class="option-svg">

        <p><?php echo __('Create Single Form', 'FRocket_admin'); ?></p>
      </div>
      <div class="option-card" data-template="multi">
        <img src="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/image/multi-step.svg" alt="<?php echo __('Multi-step Form', 'FRocket_admin'); ?>" class="option-svg">
      ...
      <div class="thumbnails">
        <div class="tiny-card" onclick="zgfm_back_general.template_single_blank()">
          <div class="zgfm-thumbnail">
            ...
            <img src="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/image/templates/blankform.svg" alt="Blank">
          </div>
          <div class="title">
        ...
        <div class="zgfm-card">
          <div class="card-content">
            <div class="card-image">
              <img src="<?php echo UIFORM_FORMS_URL . "/assets/backend/image/ajax-loader-black.gif"; ?>" alt="Image">
            </div>
