...
<div class="uiform-set-field-wrap" id="uiform-set-form-email">
   ...
   <div class="sfdc-row">
	...
	<div class="sfdc-row">
			<div class="sfdc-col-sm-12">
				<div class="sfdc-form-group">
				   <label class="sfdc-control-label" for=""><?php echo __( 'Variables', 'FRocket_admin' ); ?>: <i>(<?php echo __( 'To be used in Email Template or Submission message', 'FRocket_admin' ); ?>)</i> </label>
