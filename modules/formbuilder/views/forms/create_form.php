            ...
            <div id="uifm_content">
              ...
              <div id="uifm_main_rules_dyn">
                ...
                <div class="uifm_main_rules">
                  ...
                  <button id="uifm_mm_connection_infobox_newcond" type="button" class="btn btn-default"><?php echo __('Add new condition', 'FRocket_admin'); ?></button>
                </div>
...
<?php if (intval($fields_fastload) !== 1) { ?>
  <!-- modals -->
    ...
    for ($i = 1; $i <= 11; $i++) {
        ...
        include UIFORM_FORMS_DIR . '/modules/formbuilder/views/fields/render_back/fieldoptions_data_' . $i . '.php';
    }
