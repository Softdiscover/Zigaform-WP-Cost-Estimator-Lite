            ...
            <div class="widget-body">
                <div id="uiform-listform-options">
                    <div class="uiform-listform-options-col">
                       ...
                       href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform';?>">
                        <i class="fa fa-plus">
                        </i>
                            ...
                            <td>
                                <div class="sfdc-btn-group">
                                    ...
                                    <li><a 
                                            ...
                                            href="<?php echo admin_url().'?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=create_uiform&form_id='.$row->fmb_id;?>">
