            ...
            <div class="sfdc-row ">
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            <input class="switch-field" data-field-store="input_date2-enabletime" id="uifm_fld_inp19_enabletime" type="checkbox" />
                        </div>
            ...
            <div class="sfdc-row ">
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            <input class="switch-field" data-field-store="input_date2-nocalendar" id="uifm_fld_inp19_nocalendar" type="checkbox" />
                        </div>
            ...
            <div class="sfdc-row ">
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            <input class="switch-field" data-field-store="input_date2-time_24hr" id="uifm_fld_inp19_time24hr" type="checkbox" />
                        </div>
            ...
            <div class="sfdc-row ">
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            <input class="switch-field" data-field-store="input_date2-altinput" id="uifm_fld_inp19_altinput" type="checkbox" />
                        </div>
                ...
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            ...
                            <input type="text" class="sfdc-form-control uifm-f-setoption" name="uifm_fld_inp19_altformat" id="uifm_fld_inp19_altformat" data-field-store="input_date2-altformat">
                        </div>
            ...
            <div class="sfdc-row ">
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            <input class="switch-field" data-field-store="input_date2-isinline" id="uifm_fld_inp19_isinline" type="checkbox" />
                        </div>
                ...
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            ...
                            <input type="text" class="sfdc-form-control uifm-f-setoption" name="uifm_fld_inp19_dateformat" id="uifm_fld_inp19_dateformat" data-field-store="input_date2-dateformat">
                        </div>
            ...
            <div class="sfdc-row ">
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            <select id="uifm_fld_inp19_language" style="width:73px;" onchange="" data-field-store="input_date2-language" class="sfdc-form-control uifm-f-setoption">
                ...
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            ...
                            <input type="text" class="sfdc-form-control uifm-f-setoption" name="uifm_fld_inp19_mindate" id="uifm_fld_inp19_mindate" data-field-store="input_date2-mindate">
                        </div>
                ...
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            ...
                            <input type="text" class="sfdc-form-control uifm-f-setoption" name="uifm_fld_inp19_maxdate" id="uifm_fld_inp19_maxdate" data-field-store="input_date2-maxdate">
                        </div>
                ...
                <div class="sfdc-col-md-12">
                    <div class="sfdc-form-group">
                        ...
                        <div class="sfdc-col-md-6">
                            ...
                            <input type="text" class="sfdc-form-control uifm-f-setoption" name="uifm_fld_inp19_defaultdate" id="uifm_fld_inp19_defaultdate" data-field-store="input_date2-defaultdate">
                        </div>
