    ...
    <div class="sfdc-row">
        <div class="sfdc-col-md-6">
            <div class="sfdc-form-group">
                ...
                <select id="uifm_fld_inp7_lang" data-field-store="input7-language" class="sfdc-form-control input-sm uifm-f-setoption">
        ...
        <div class="sfdc-col-sm-6">
            <div class="sfdc-form-group">
                ...
                <select id="uifm_fld_inp7_format" data-field-store="input7-format" class="sfdc-form-control input-sm uifm-f-setoption">
