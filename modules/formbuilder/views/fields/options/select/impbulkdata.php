...
<div class='sfdc-wrap'>
    ...
    <strong><?php echo __('Info', 'FRocket_admin'); ?></strong> <?php echo __('Paste the csv content, the fields have to to be delimited by "|". the headears will go in the next order: label, value, price. Check the example:  ', 'FRocket_admin'); ?> <a href="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/sample/select-bulkdata.csv"><?php echo __('Download here', 'FRocket_admin'); ?></a>
    </div>
