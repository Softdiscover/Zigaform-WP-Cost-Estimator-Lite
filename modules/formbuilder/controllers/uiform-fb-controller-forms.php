...
class Uiform_Fb_Controller_Forms extends Uiform_Base_Module {
    ...
    public function ajax_pdf_showsample() {
        ...
        $output = uifm_generate_pdf($content, $file_name, false);
        $status='0';
    ...
    public function ajax_load_preview_form() {
        ...
        <iframe src="<?php echo site_url();?>/?uifm_costestimator_api_handler&action=uifm_est_api_handler&uifm_action=1&uifm_mode=lmode&id=<?php echo $form_id;?>" 
        scrolling="no" 
    ...
    public function list_uiforms() {
        ...
        //list all forms
        $data = $config = array();
        $config['base_url'] = admin_url() . '?page=zgfm_cost_estimate&mod=formbuilder&controller=forms&action=list_uiforms';
