...
class Uiform_Fb_Controller_Forms extends Uiform_Base_Module
{
    ...
    public function ms_filter_form_css($default,$formid)
    {
        ...
        return $default.self::render_template('formbuilder/views/forms/formhtml_css_progressbar.php', $data);
    }
    ...
    public function ms_progressbarcost_css($default, $formid)
    {
        ...
        return $default.self::render_template('formbuilder/views/forms/formhtml_css_progressbar_cost.php', $data);
    }
    ...
    {
        $redirectUrl = '';
        if ((isset($dump_form['app_ver']) && in_array($dump_form['app_ver'], ['7.0.0','7.4.2'], true) ) ||
    ...
    */
    ...
    public function generate_form_sticky()
    {
        $data            = array();
        $data['summbox'] = $this->current_data_summbox;
        return self::render_template('formbuilder/views/forms/formhtml_sticky.php', $data);
    }
    ...
    public function list_uiforms()
    {
        if( ZIGAFORM_F_LITE  !== 1){
            $validateLicense = get_option('zgfm_wpce_code', []);
