    ...
    public function load_field_options($type, $id, $block = null) {
        ...
        switch (intval($type)) {
            ...
            case 5:
                ...
                $data['modules_field_more']='hola amiguitos';
             ...
             case 32: case 33: case 34: case 35: case 36: case 37: case 38: case 39: case 40: case 41: case 42:case 43:
               ...
               switch ($tmp_type) {
                   ...
                   case 8:
                    ...
                    case 43:
                    /* date 2 */
                    $data['render_block_type'] =  self::render_template('formbuilder/views/fields/render_css_front/type_date2.php', $data, 'always');
                        break;
              ...
              case 33: case 34: case 35: case 36: case 37: case 38: case 39: case 40: case 41: case 42: case 43:
               ...
               switch ($tmp_type) {
                   ...
                   case 33:case 34:case 35:case 36:case 37:case 38:
                    ...
                    case 43:
                    /*date 2*/
                        $data['render_block_input'] =  self::render_template('formbuilder/views/fields/render_front/type_date2.php', $data, 'always');
