...
class Uiform_Fb_Controller_Settings extends Uiform_Base_Module
{
    ...
    public function ajax_save_options()
    {
        ...
        if ( (string) $opt_modalmode === 'on') {
            update_option('zgfm_c_modalmode', 1);
        } else {
    ...
    public function system_check()
    {
        ...
        $uiform_tbs   = array();
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_form';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_form_records';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_fields';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_fields_type';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_settings';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_pay_gateways';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_pay_records';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_pay_logs';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_visitor';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_visitor_error';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_uiform_form_log';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_addon';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_addon_details';
        $uiform_tbs[] = $this->wpdb->prefix . 'cest_addon_details_log';

        // tables
        $name_tb = array();
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_form' ]          = 'Forms';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_form_records' ]  = 'Records';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_fields' ]        = 'Fields';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_fields_type' ]   = 'Types';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_settings' ]      = 'Settings';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_pay_gateways' ]  = 'Gateways';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_pay_records' ]   = 'G records';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_pay_logs' ]      = 'G logs';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_visitor' ]       = 'G visitor';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_visitor_error' ] = 'V. Error';
        $name_tb[ $this->wpdb->prefix . 'cest_uiform_form_log' ]      = 'Form Log';
        $name_tb[ $this->wpdb->prefix . 'cest_addon' ]                = 'Addon';
        $name_tb[ $this->wpdb->prefix . 'cest_addon_details' ]        = 'Addon detail';
        $name_tb[ $this->wpdb->prefix . 'cest_addon_details_log' ]    = 'Addon log';
