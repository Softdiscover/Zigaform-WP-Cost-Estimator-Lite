    ...
    <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
        ...
        <?php } ?>
            ...
            <div class="form-group">
              ...
              <?php echo __('Warning! if you have some changes on the translations and you are about to make an upgrade of the software, make a backup before, just copying the po and mo files from the next directory: ', 'FRocket_admin'); ?> <?php echo UIFORM_FORMS_URL . '/i18n/'; ?><br>
              <?php echo __('Then after the upgrade is done, just replace/overwrite the po and mo files using your backup in order to keep the changes. also you can send your translations to zigaform.com  in order to keep your translations on future version updates. ', 'FRocket_admin'); ?>
                ...
                <div id="zgfmLanguageContent">
                    <img src="<?php echo UIFORM_FORMS_URL . '/assets/backend/image/ajax-loader-black.gif'; ?>">
                </div>
            </div>
...
<?php include(UIFORM_FORMS_DIR . '/views/footer-global.php'); ?>
