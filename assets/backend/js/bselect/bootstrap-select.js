...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    init: function () {
      ...
      this.$menu = this.$newElement.find('> .sfdc-dropdown-menu');
    ...
    createDropdown: function () {
      ...
      var searchbox = this.options.liveSearch ? '<div class="bootstrap-select-searchbox"><input type="text" class="input-block-level sfdc-form-control" autocomplete="off" /></div>' : '';
      var actionsbox = this.options.actionsBox ? '<div class="bs-actionsbox">' +
          '<div class="sfdc-btn-group btn-block">' +
