		...
		window.rocketfm = rocketfm = $.rocketfm = function () {
			...
			arguments.callee.genpdf_inforecord = function (rec_id) {
				try {
					$('body').append(
						"<iframe src='" +
							rockfm_vars.url_site +
							'?uifm_costestimator_api_handler&zgfm_action=uifm_est_api_handler&uifm_action=show_record&uifm_mode=pdf&id=' +
							rec_id +
			...
			arguments.callee.genpdf_infoinvoice = function (rec_id) {
				try {
					$('body').append(
						"<iframe src='" +
							rockfm_vars.url_site +
							'?uifm_costestimator_api_handler&zgfm_action=uifm_est_api_handler&uifm_action=show_invoice&uifm_mode=pdf&id=' +
							rec_id +
							"' style='display: none;' ></iframe>"
					);
				} catch (ex) {
